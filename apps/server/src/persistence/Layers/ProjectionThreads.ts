    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.latestImportedMessageAt ?? null},
        ...
        DO UPDATE SET
          ...
          latest_imported_message_at = excluded.latest_imported_message_at,
    ...
    execute: ({ threadId }) =>
      sql`
        SELECT
          ...
          latest_imported_message_at AS "latestImportedMessageAt",
